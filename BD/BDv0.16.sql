...
CREATE TABLE IF NOT EXISTS `scc`.`Pessoa` (
  ...
  `foto` VARCHAR(250) NULL,
  `Vinculo_idVinculo` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `scc`.`Sped` (
  ...
  `Secao_idSecao` INT NULL,
  PRIMARY KEY (`idSped`),
  INDEX `fk_Sped_Pessoa1_idx` (`Pessoa_idPessoa` ASC) VISIBLE,
  INDEX `fk_Sped_Secao1_idx` (`Secao_idSecao` ASC) VISIBLE,
  CONSTRAINT `fk_Sped_Pessoa1`
    FOREIGN KEY (`Pessoa_idPessoa`)
    REFERENCES `scc`.`Pessoa` (`idPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Sped_Secao1`
    FOREIGN KEY (`Secao_idSecao`)
    REFERENCES `scc`.`Secao` (`idSecao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `scc`.`ExamePagamentoEfetivo`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `scc`.`Sped_has_Secao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `scc`.`Sped_has_Secao` ;

CREATE TABLE IF NOT EXISTS `scc`.`Sped_has_Secao` (
  `Sped_idSped` INT NOT NULL,
  `Secao_idSecao` INT NOT NULL,
  PRIMARY KEY (`Sped_idSped`, `Secao_idSecao`),
  INDEX `fk_Sped_has_Secao_Secao1_idx` (`Secao_idSecao` ASC) VISIBLE,
  INDEX `fk_Sped_has_Secao_Sped1_idx` (`Sped_idSped` ASC) VISIBLE,
